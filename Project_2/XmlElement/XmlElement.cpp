...
std::shared_ptr<AbstractXmlElement> XmlProcessing::makeDocElement(std::shared_ptr<AbstractXmlElement> pRoot, std::shared_ptr<AbstractXmlElement> dec, std::shared_ptr<AbstractXmlElement> comm)
{
  std::shared_ptr<AbstractXmlElement> ptr(new DocElement(pRoot,dec,comm));
  return ptr;
}
...
DocElement::DocElement(std::shared_ptr<AbstractXmlElement> pRoot, std::shared_ptr<AbstractXmlElement> dec, std::shared_ptr<AbstractXmlElement> com)
{
	if (dec!=NULL)
	children_.push_back(dec);
	if (com != NULL)
...
std::string CommentElement::value()
{
	return commentText_;
}
