...
namespace XmlProcessing
{
  ...
  inline std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::children() { return children_; }
  ...
  {
  public:
	  DocElement(std::shared_ptr<AbstractXmlElement> pRoot = nullptr, std::shared_ptr<AbstractXmlElement> dec=nullptr, std::shared_ptr<AbstractXmlElement> elem=nullptr);
    ~DocElement() {}
	...
	std::vector<std::shared_ptr<AbstractXmlElement>>& getChildren();
  ...
  std::shared_ptr<AbstractXmlElement> makeDocElement(std::shared_ptr<AbstractXmlElement> pRoot = nullptr, std::shared_ptr < AbstractXmlElement > dec=nullptr, std::shared_ptr < AbstractXmlElement > comm=nullptr);
