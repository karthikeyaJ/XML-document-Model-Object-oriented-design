...
namespace XmlProcessing
{
	...
	public:
		...
		bool finding(const std::string& tok1, const std::string& tok2);
		bool isDeclaration(const std::string& str);
		bool isComment(const std::string& str);
		bool isStartingOfTag(const std::string& str);
		bool isEndingOfTag(const std::string& str);
		std::shared_ptr<AbstractXmlElement> collects(const std::string& str);
		std::vector<std::string> declareElements(const std::string& s);
